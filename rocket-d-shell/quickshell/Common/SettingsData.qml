...
Singleton {
    ...
    readonly property string pluginSettingsPath: _configDir + "/RocketDShell/plugin_settings.json"
    ...
    property string currentThemeName: "rocket_d"
    ...
    FileView {
        ...
        path: StandardPaths.writableLocation(StandardPaths.ConfigLocation) + "/RocketDShell/settings.json"
        blockLoading: true
        blockWrites: true
        atomicWrites: true
        watchChanges: true
