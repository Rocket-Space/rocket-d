...
Singleton {
    ...
    readonly property url data: `${StandardPaths.standardLocations(StandardPaths.GenericDataLocation)[0]}/RocketDShell`
    readonly property url state: `${StandardPaths.standardLocations(StandardPaths.GenericStateLocation)[0]}/RocketDShell`
    readonly property url cache: `${StandardPaths.standardLocations(StandardPaths.GenericCacheLocation)[0]}/RocketDShell`
    readonly property url config: `${StandardPaths.standardLocations(StandardPaths.GenericConfigLocation)[0]}/RocketDShell`
    ...
    function getAppName(appId: string, desktopEntry: var): string {
        if (appId === "org.quickshell" || appId === "com.rocket.dshell") {
            return "dms";
        }
