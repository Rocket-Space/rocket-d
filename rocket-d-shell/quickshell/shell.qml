...
//@ pragma AppId com.rocket.dshell
...
ShellRoot {
    ...
    readonly property bool disableHotReload: Quickshell.env("ROCKET_D_DISABLE_HOT_RELOAD") === "1" || Quickshell.env("ROCKET_D_DISABLE_HOT_RELOAD") === "true"
