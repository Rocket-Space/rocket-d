...
BasePill {
    ...
    function buildBaseItems() {
        ...
        sortedToplevels.forEach((toplevel, index) => {
            ...
            if (rawAppId === "org.quickshell" || rawAppId === "com.rocket.dshell") {
            ...
            Item {
                ...
                Rectangle {
                    ...
                    IconImage {
                        ...
                        layer.enabled: appItem.appId === "org.quickshell" || appItem.appId === "com.rocket.dshell"
                        layer.smooth: true
                        layer.mipmap: true
                    ...
                    onClicked: mouse => {
                        if (mouse.button === Qt.RightButton) {
                            ...
                            if (contextMenuLoader.item) {
                                ...
                                const shouldHidePin = modelData.appId === "org.quickshell" || modelData.appId === "com.rocket.dshell";
                                const moddedId = Paths.moddedAppId(modelData.appId);
