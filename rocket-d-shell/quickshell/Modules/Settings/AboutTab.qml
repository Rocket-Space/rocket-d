...
Item {
    ...
    DankFlickable {
        ...
        Column {
                ...
                Column {
                    ...
                    Row {
                        ...
                        DankButton {
                            ...
                            backgroundColor: Theme.surfaceTextHover
                            textColor: Theme.surfaceText
                            onClicked: Qt.openUrlExternally("https://github.com/Rocket-Space/rocket-d-shell")
                            onHoveredChanged: {
                                if (hovered)
                                    resourceTooltip.show(resourceButtonsRow.compactMode ? "GitHub - Rocket-Space/rocket-d-shell" : "github.com/Rocket-Space/rocket-d-shell", githubButton, 0, 0, "bottom");
                                else
                                    resourceTooltip.hide();
                            }
                        }
            ...
            StyledText {
                anchors.horizontalCenter: parent.horizontalCenter
                text: I18n.tr('<a href="https://github.com/Rocket-Space/rocket-d-shell/blob/master/LICENSE" style="text-decoration:none; color:%1;">MIT License</a>').arg(Theme.surfaceVariantText)
                font.pixelSize: Theme.fontSizeMedium
                color: Theme.surfaceVariantText
                textFormat: Text.RichText
