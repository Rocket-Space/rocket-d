    ...
    DankFlickable {
        ...
        Column {
                            ...
                            Repeater {
                                ...
                                Rectangle {
                                    ...
                                    property string previewPath: {
                                        const baseDir = Quickshell.env("HOME") + "/.config/RocketDShell/themes/" + (modelData.sourceDir || modelData.id);
                                    ...
                                    MouseArea {
                                        ...
                                        cursorShape: Qt.PointingHandCursor
                                        onClicked: {
                                            const themesDir = Quickshell.env("HOME") + "/.config/RocketDShell/themes";
            ...
            SettingsCard {
                ...
                StyledText {
                    text: I18n.tr('Generate baseline GTK3/4 or QT5/QT6 (requires qt6ct-kde) configurations to follow DMS colors. Only needed once.<br /><br />It is recommended to configure <a href="https://github.com/AvengeMedia/RocketDShell/blob/master/README.md#Theming" style="text-decoration:none; color:%1;">adw-gtk3</a> prior to applying GTK themes.').arg(Theme.primary)
