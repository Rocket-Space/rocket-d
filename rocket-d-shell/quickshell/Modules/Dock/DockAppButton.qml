...
Item {
        ...
        function handleLeftClick() {
            ...
            case "grouped":
                if (appData.windowCount === 0) {
                    ...
                    const shouldHidePin = appData.appId === "org.quickshell" || appData.appId === "com.rocket.dshell";
    ...
    Item {
        ...
        IconImage {
            ...
            anchors.centerIn: parent
            implicitSize: appData && (appData.appId === "org.quickshell" || appData.appId === "com.rocket.dshell") ? actualIconSize * 0.85 : actualIconSize
            source: {
                if (!appData || appData.appId === "__SEPARATOR__") {
                    return "";
                }
            ...
            layer.enabled: appData && (appData.appId === "org.quickshell" || appData.appId === "com.rocket.dshell")
            layer.smooth: true
            layer.mipmap: true
