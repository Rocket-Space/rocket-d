...
import (
	...
	"github.com/Rocket-Space/rocket-d-shell/core/internal/distros"
	"github.com/Rocket-Space/rocket-d-shell/core/internal/errdefs"
	"github.com/Rocket-Space/rocket-d-shell/core/internal/log"
	"github.com/Rocket-Space/rocket-d-shell/core/internal/privesc"
	"github.com/Rocket-Space/rocket-d-shell/core/internal/utils"
	"github.com/Rocket-Space/rocket-d-shell/core/internal/version"
...
func offerReclone(dmsPath string) bool {
	...
	cloneCmd := exec.Command("git", "clone", "--recurse-submodules", "https://github.com/Rocket-Space/rocket-d-shell.git", dmsPath)
...
func updateDMSBinary() error {
	...
	cmd := exec.Command("curl", "-s", "https://api.github.com/repos/Rocket-Space/rocket-d-shell/releases/latest")
	output, err := cmd.Output()
	if err != nil {
	...
	binaryURL := fmt.Sprintf("https://github.com/Rocket-Space/rocket-d-shell/releases/download/%s/dms-cli-%s.gz", version, arch)
	checksumURL := fmt.Sprintf("https://github.com/Rocket-Space/rocket-d-shell/releases/download/%s/dms-cli-%s.gz.sha256", version, arch)
